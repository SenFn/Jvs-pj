                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="box-footer info-contact">
                                        ...
                                        <div class="content-contact">
                                                <p>Website chuyên cung cấp thiết bị điện tử uy tín nuôn</p>
                                                <p>
                                                        <strong>Địa chỉ:</strong> 11 Bùi Đình Túy, phường 26, quận Bình Thạnh, Tp.HCM
                                                </p>
                                                <p>
                                                        <strong>Email: </strong> no.reply.storeservice8479@gmail.com
                                                </p>
                                                <p>
                                                        <strong>Điện thoại: </strong> xxxxxxxxx
                                                </p>
                                        </div>
                                </div>
                        </div>
