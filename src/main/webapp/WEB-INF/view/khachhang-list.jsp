                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody style="background:#ccc">
                                        <!-- Lấy từ model persons --><c:forEach items="${khachhangs}" var="khachHang">
                                            ...
                                            <c:url var="viewUrl" value="/hoadon/list">
                                                ...
                                                <c:forEach items="${khachHang.hoaDons}" var="hoaDon">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><c:out value="${khachHang.tenKhachHang}" /></td>
                                                        <td><c:out value="${khachHang.soDienThoaikh}" /></td>
                                                        <td><c:out value="${khachHang.email}" /></td>                                    
                                                        <td><a href="${editUrl}"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i> </a></td>
                                                        <td><a href="${deleteUrl}"><i class="fa fa-trash fa-2x"></i></a></td>
                                                        <td style="text-align: center"><a href="${viewUrl}"><i class="fa fa-info fa-2x" aria-hidden="true" ></i></a></td>
                                                            </c:forEach>
