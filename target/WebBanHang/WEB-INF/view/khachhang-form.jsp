            ...
            <header>
                ...
                <div class="row mt-3">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title">Sửa thông tin khách hàng</h1>
                                <div class="table-responsive">
                                    ...
                                    <form:form modelAttribute="khachhang" method="POST" action="${saveUrl}">
                                       ...
                                       knows which customer to form the update operation on. 
                                        ...
                                        <table>
                                            <tr>
                                                <td><form:label path="tenKhachHang">-Họ tên: </form:label></td>
                                                <td style="width: 92%"><form:input path="tenKhachHang"/></td>
                                            </tr>
                                            <tr>
                                                <td><form:label path="soDienThoaikh">-Số điện thoại: </form:label></td>
                                                <td><form:input path="soDienThoaikh"/></td>
                                            </tr>
